...
export default async function CmsPage({ params: { locale, slug } }: { params: { locale: string; slug: string } }) {
  let page: { title_fa?: string; title_en?: string; body_fa?: string | null; body_en?: string | null } | null = null;
  try { const res = await apiServer<{ data: typeof page }>(`/v1/public/pages/${slug}`); page = res.data; } catch {}
