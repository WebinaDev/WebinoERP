...
const EXACT: Record<string, DashboardRouteMeta> = {
  ...
  'admin/marketplace/products': { titleFa: 'محصولات بازارچه', titleEn: 'Marketplace products', group: 'admin', apiHint: '/v1/marketplace/modules' },
  ...
  'admin/marketplace/gitea': { titleFa: 'Gitea', titleEn: 'Gitea', group: 'admin', apiHint: '/v1/marketplace/gitea/settings' },
  'admin/marketplace/basalam': { titleFa: 'باسلام (OAuth)', titleEn: 'Basalam (OAuth)', group: 'admin', apiHint: '/v1/marketplace/basalam' },
