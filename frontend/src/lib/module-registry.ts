...
export const ERP_MODULES: ErpModuleDef[] = [
  ...
  },
  {
    ...
    sidebarCategoryKey: 'nav.module.platform',
    defaultEnabled: true,
    menuItems: [
      {
        id: 'platform-menu',
        path: 'admin/platform',
        titleKey: 'nav.erp.platform.group',
        icon: 'ri-cloud-line',
        children: [
          ...
          { id: 'platform-services', path: 'admin/platform/services', titleKey: 'nav.erp.platform.services', icon: 'ri-apps-line', requiredPermission: 'platform.resources.view' },
          { id: 'platform-sources', path: 'admin/platform/sources', titleKey: 'nav.erp.platform.sources', icon: 'ri-git-branch-line', requiredPermission: 'platform.manage' },
          { id: 'platform-storages', path: 'admin/platform/storages', titleKey: 'nav.erp.platform.storages', icon: 'ri-database-2-line', requiredPermission: 'platform.manage' },
          { id: 'platform-backups', path: 'admin/platform/backups', titleKey: 'nav.erp.platform.backups', icon: 'ri-save-3-line', requiredPermission: 'platform.manage' },
          { id: 'platform-keys', path: 'admin/platform/keys', titleKey: 'nav.erp.platform.keys', icon: 'ri-key-line', requiredPermission: 'platform.servers.manage' },
          { id: 'platform-tokens', path: 'admin/platform/tokens', titleKey: 'nav.erp.platform.tokens', icon: 'ri-shield-keyhole-line', requiredPermission: 'platform.settings.manage' },
          { id: 'platform-variables', path: 'admin/platform/variables', titleKey: 'nav.erp.platform.variables', icon: 'ri-code-box-line', requiredPermission: 'platform.manage' },
          { id: 'platform-tags', path: 'admin/platform/tags', titleKey: 'nav.erp.platform.tags', icon: 'ri-price-tag-3-line', requiredPermission: 'platform.manage' },
          { id: 'platform-notifications', path: 'admin/platform/notifications', titleKey: 'nav.erp.platform.notifications', icon: 'ri-notification-3-line', requiredPermission: 'platform.settings.manage' },
          { id: 'platform-terminal', path: 'admin/platform/terminal', titleKey: 'nav.erp.platform.terminal', icon: 'ri-terminal-box-line', requiredPermission: 'platform.terminal' },
          { id: 'platform-settings', path: 'admin/platform/settings', titleKey: 'nav.erp.platform.settings', icon: 'ri-settings-3-line', requiredPermission: 'platform.settings.manage' },
        ],
      },
    ],
    legacyRedirects: [
    ...
    menuItems: [
      {
        ...
        children: [
          ...
          { id: 'ai-content-cms-pages', path: 'marketing/pages', titleKey: 'nav.erp.aiContent.cmsPages', icon: 'ri-pages-line' },
